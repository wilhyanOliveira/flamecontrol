...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    if (!empty($descricao)) 
    {
        ...
        $verifica_existente = "SELECT COUNT(*) AS total FROM T_DIFICUL_ATEND WHERE descricao = '$descricao'";
        ...
        {
            $sql = "INSERT INTO T_DIFICUL_ATEND (DESCRICAO, ATIVO) VALUES ('$descricao', '$ativo')";
        }

        if (mysqli_query($conn, $sql)) 
        {
            header("location: /flamecontrol/Views/Pages/pages_admin/cadastro_dificldade.php");
            exit;  
        } 
        else 
        {
