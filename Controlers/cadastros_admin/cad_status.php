...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    if (!empty($descricao)) 
    {
        ...
        $verifica_existente = "SELECT COUNT(*) AS total FROM T_STATUS_ATENDIMENTO WHERE descricao = '$descricao'";
        ...
        else 
        {
            ...
            $sql = "INSERT INTO T_STATUS_ATENDIMENTO (DESCRICAO, ATIVO) VALUES ('$descricao', '$ativo')";
        }
        ...
        if (mysqli_query($conn, $sql)) 
        {
            ...
            header("location: /flamecontrol/Views/Pages/pages_admin/cadastro_status.php");
            exit;  
        } 
        else 
        {
